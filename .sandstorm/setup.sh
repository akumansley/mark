...
set -euo pipefail  # e - fail on error, u - something, -o treat pipe failures as failures
...
export DEBIAN_FRONTEND=noninteractive  # don't ask me questions
apt-get update

# Install Node 4
# stolen from
# https://github.com/sandstorm-io/vagrant-spk/blob/master/stacks/node/setup.sh
